<?php
    ...
    $videoactions = $result->fetch_all(MYSQLI_ASSOC);
    // echo '<pre>';
    // print_r($spoilers);
    // exit;
?>
            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a href="#" class="active" style="font-family: 'Noto Sans Thai', sans-serif;">ข้อมูลภาพยนตร์แอ็กชัน</a>
                  </li>
                </ul>
                <!-- END BREADCRUMB -->
              </div>
          ...
          <div class="container-fluid container-fixed-lg bg-white">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                <div class="panel-title" style="font-family: 'Noto Sans Thai', sans-serif;">ข้อมูลภาพยนตร์แอ็กชัน</div>
                <div class="pull-right">
                  ...
                  <div class= "col-xs-4">
                  <button type="submit" id="aadVideoaction" class="btn btn-complete btn-cons btn-animated from-left fa fa-plus btn-rounded">
              ...
              <div class="panel-body" >
                <table class="table table-hover demo-table-search table-responsive-block" id="spoilerTable" >
                  ...
                  <tbody>
                  <?php
                  foreach($videoactions AS $index => $videoaction){
                    ?>
                  
                    <tr>
                      <td class="v-align-middle semi-bold">
                        <p> <?php echo $videoaction['videoactionID']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $videoaction['action_name']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $videoaction['action_category']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $videoaction['action_details']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $videoaction['actor']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $videoaction['director']; ?></p>
                      </td>
                      <td class="v-align-middle">
                      <video width="200px" height="100px" controls="controls">
                        <source src="<?php echo $videoaction['video_action']; ?>" type="video/mp4">
                      </video>
                      </td>
                      <td class="v-align-middle">
                        <p><img width="200px" height="100px" src="<?php echo $videoaction['action_img']; ?>"></p>
                      </td>


                      <td class="v-align-middle">
                        <div>
                        <a href="edit-video-action.php?action=edit&videoactionID=<?php echo $videoaction['videoactionID']; ?>">
                        ...
                        <br>
                        <div>
                        <a class="edit-video-action" href="edit-video-action.php?action=delete&videoactionID=<?php echo $videoaction['videoactionID']; ?> ">
