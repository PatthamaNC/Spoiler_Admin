<?php
    ...
    if (isset($_POST['action']) && $_POST['action'] == 'report-detail') {
        ...
        foreach($reportDetail AS $idx => $item) {
          ...
          $reportDetailMessage .= "<td>".$item['spoiler_name']."</td>";
          $reportDetailMessage .= "<td>".$item['reason']."</td>";
          $reportDetailMessage .= "<td>".$item['spoiler_category']."</td>";
          $reportDetailMessage .= "</tr>";
        }
    ...
    $report_spoilers = $result->fetch_all(MYSQLI_ASSOC);
    // echo '<pre>';
    // print_r($report_spoilers);
    // exit;
?>
<!DOCTYPE html>
<html>
            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a style="font-family: 'Noto Sans Thai', sans-serif;" href="#" class="active">ข้อมูลรายงานรีวิวภาพยนตร์สปอยล์รอตรวจสอบ</a>
                  </li>
                </ul>
                <!-- END BREADCRUMB -->
              </div>
          ...
          <div class="container-fluid container-fixed-lg bg-white">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                <div style="font-family: 'Noto Sans Thai', sans-serif; font-size: 15px;" class="panel-title">ข้อมูลรายงานรีวิวภาพยนตร์สปอยล์รอตรวจสอบ</div>
                ...
                <table class="table table-hover demo-table-search table-responsive-block" id="videoHorrorTable">
                  <thead>
                    <tr>
                      ...
                      <th style="font-family: 'Noto Sans Thai', sans-serif;">ภาพยนตร์ที่ถูกรายงาน</th>                      
                      ...
                      <th style="font-family: 'Noto Sans Thai', sans-serif;">ผู้ถูกรายงาน</th>
                  ...
                  <tbody>
                  <?php
                  foreach($report_spoilers AS $index => $report_spoiler){

                    $MB = $report_spoiler['spoiler_id'];
                    $sql2 = "
                    SELECT 
                    report_spoiler.reportspoilerID,
                          member.fname,
                          spoiler.member_id
                          FROM spoiler, member, report_spoiler
                          WHERE spoiler.spoilerID = report_spoiler.spoiler_id 
                          AND member.id = spoiler.member_id 
                          AND report_spoiler.spoiler_id = '$MB'
                    ";
                    ...
                    <tr>
                      <td class="v-align-middle semi-bold">
                        <p> <?php echo $report_spoiler['reportspoilerID']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $report_spoiler['spoiler_name']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $report_spoiler['fname']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $report_spoiler['reason']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $row2['fname']; ?></p>
                      </td>
                      <!-- <td class="v-align-middle">
                        <p><?php echo $report_spoiler['status']; ?></p>
                      </td> -->
                      <td class="v-align-middle">
                        ...
                        <!-- <button class="btn btn-complete btn-cons m-b-10 btn-rounded report-detail" 
                          ...
                          <span class="bold">รายละเอียด</span> fa fa-pencil-square-o   from-left 
                        </button> -->

                        <a href="details-report-spoiler.php?action=edit&spoilerID=<?php echo $report_spoiler['spoiler_id']; ?>">
                          <button  class="btn btn-complete btn-cons btn-animated btn-rounded  ">
                          <i class="pg pg-note"></i><span class="bold">รายละเอียด</span>
                          </button>
                        </a>
                        <br><br>
                        <a href="inform-report-spoiler.php?action=send&reportspoilerID=<?php echo $row2['member_id']; ?>">
                        ...
                        <a href="update-status-spoiler.php?action=edit&reportspoilerID=<?php echo $report_spoiler['reportspoilerID']; ?>">
