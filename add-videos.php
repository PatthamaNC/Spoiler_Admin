<?php
    ...
    if(isset($_POST['buttonAddVideoCartoon'])) {
      ...
      if (isset($_FILES['picture']) && $_FILES['picture']['size'] > 0){
        ...
        if(!in_array($pictureEntension, ["png","jpg","jpeg"])){
          echo "กรุณาเลือกไฟล์ .png หรือ jpg  jpegเท่านั้น";
          exit;
        }
            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a href="#" class="active" style="font-family: 'Noto Sans Thai', sans-serif;">เพิ่มข้อมูลวิดีโอภาพยนตร์สปอยล์</a></li>
                </ul>
                <!-- END BREADCRUMB -->
              </div>
            </div>
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                  ...
                  <div class="panel-body">
                        <h5 style="font-family: 'Noto Sans Thai', sans-serif; margin-left: 40%; font-weight: bold; font-size: 20px;">
                            เพิ่มข้อมูลวิดีโอภาพยนตร์สปอยล์
						            </h5><br>
                    <form class="" role="form" name="aadVideoCartoonForm" id="aadVideoCartoonForm"  action="" method="POST"  enctype="multipart/form-data">
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group form-group-default ">
                            <label style="font-family: 'Noto Sans Thai', sans-serif;">ชื่อภาพยนตร์</label>
                            <input type="text" class="form-control" name="name" style="font-family: 'Noto Sans Thai', sans-serif;">
                          </div>
                        </div>
                        ...
                        <!-- <div class="col-sm-6">
                          <div class="form-group form-group-default">
                            ...
                            <input type="text" class="form-control" name="action_category" style="font-family: 'Noto Sans Thai', sans-serif;">
                          </div>
                        </div> -->
                        ...
                        <div class="col-sm-6">
                          <div class="form-group form-group-default ">
                            ...
                            <input type="text" class="form-control" name="actor" style="font-family: 'Noto Sans Thai', sans-serif;">
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group form-group-default">
                            <label style="font-family: 'Noto Sans Thai', sans-serif;">ผู้กำกับ</label>
                            <input type="text" class="form-control" name="director" style="font-family: 'Noto Sans Thai', sans-serif;">
                          </div>
                        </div>
                        </div>
                        </div>
                        ...
                        <input type="text" class="form-control" name="details" style="font-family: 'Noto Sans Thai', sans-serif;">
                        </div>
                        ...
                        <button type="submit" id="buttonAddVideoCartoon" name="buttonAddVideoCartoon" class="btn btn-primary btn-cons btn-animated from-top fa fa-arrow-down btn-save">
