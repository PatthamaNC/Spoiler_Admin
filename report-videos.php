            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a style="font-family: 'Noto Sans Thai', sans-serif;" href="#" class="active">ข้อมูลรายงานวิดีโอภาพยนตร์สปอยล์รอตรวจสอบ</a>
                  </li>
                </ul>
                <!-- END BREADCRUMB -->
              </div>
          ...
          <div class="container-fluid container-fixed-lg bg-white">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                <div style="font-family: 'Noto Sans Thai', sans-serif; font-size: 15px;" class="panel-title">ข้อมูลรายงานวิดีโอภาพยนตร์สปอยล์รอตรวจสอบ</div>
                  ...
                  foreach($report_videos AS $index => $report_video){
                    ...
                    <tr>
                      ...
                      <td class="v-align-middle">
                        ...
                        <a href="update-status-video.php?action=edit&reportvideoID=<?php echo $report_video['reportvideoID']; ?>">
