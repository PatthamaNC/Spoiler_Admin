<?php
    ...
    $sql = "
    SELECT * FROM videoromantic
    ORDER BY videoromanticID DESC
    ";
    ...
    $videoromantics = $result->fetch_all(MYSQLI_ASSOC);
    // echo '<pre>';
    // print_r($spoilers);
    // exit;
?>
            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a href="#" class="active" style="font-family: 'Noto Sans Thai', sans-serif;">ข้อมูลภาพยนตร์โรแมนติก</a>
                  </li>
                </ul>
                <!-- END BREADCRUMB -->
              </div>
          ...
          <div class="container-fluid container-fixed-lg bg-white">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                <div class="panel-title" style="font-family: 'Noto Sans Thai', sans-serif;">ข้อมูลภาพยนตร์โรแมนติก</div>
              ...
              <div class="panel-body" >
                <table class="table table-hover demo-table-search table-responsive-block" id="spoilerTable" >
                  ...
                  <tbody>
                  <?php
                  foreach($videoromantics AS $index => $videoromantic){
                    ?>
                  
                    <tr>
                      <td class="v-align-middle semi-bold">
                        <p> <?php echo $videoromantic['videoromanticID']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $videoromantic['romantic_name']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $videoromantic['romantic_category']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $videoromantic['romantic_details']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $videoromantic['actor']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $videoromantic['director']; ?></p>
                      </td>
                      <td class="v-align-middle">
                      <video width="200px" height="100px" controls="controls">
                        <source src="<?php echo $videoromantic['video_romantic']; ?>" type="video/mp4">
                      </video>
                      </td>
                      <td class="v-align-middle">
                        <p><img width="200px" height="100px" src="<?php echo $videoromantic['romantic_img']; ?>"></p>
                      </td>


                      <td class="v-align-middle">
                        <div>
                        <a href="edit-video-romantic.php?action=edit&videoromanticID=<?php echo $videoromantic['videoromanticID']; ?>">
                        ...
                        <br>
                        <div>
                        <a class="edit-video-romantic" href="edit-video-romantic.php?action=delete&videoromanticID=<?php echo $videoromantic['videoromanticID']; ?> ">
...
var initspoilerTable = function() {
    ...
    $('#aadVideoaction').click(function () {
      ...
      window.location.href = "add-video-romantic.php";
    });
    ...
    $("#spoilerTable").delegate(".edit-video-romantic", "click", function (event) {
