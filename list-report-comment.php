            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a style="font-family: 'Noto Sans Thai', sans-serif;" href="#" class="active">ข้อมูลรายงานความคิดเห็นรีวิวภาพยนตร์สปอยล์</a>
                  </li>
                </ul>
                <!-- END BREADCRUMB -->
              </div>
          ...
          <div class="container-fluid container-fixed-lg bg-white">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                <div style="font-family: 'Noto Sans Thai', sans-serif; font-size: 15px;" class="panel-title">ข้อมูลรายงานความคิดเห็นรีวิวภาพยนตร์สปอยล์</div>
              ...
              <div class="panel-body">
                <table class="table table-hover demo-table-search table-responsive-block" id="videoHorrorTable">
                  ...
                  <tbody>
                  <?php
                  foreach($report_comments AS $index => $report_comment){
                    $MB = $report_comment['comment_id'];
                    $sql2 = "
                    SELECT 
                          report_comment.reportcommentID,
                          comment_spoiler.message,
                          member.fname,
                          member.status,
                          comment_spoiler.member_id
                          FROM comment_spoiler, member, report_comment
                          WHERE comment_spoiler.commentID = report_comment.comment_id  AND member.status = '  '
                    ...
                    <tr>
                      <td class="v-align-middle semi-bold">
                        <p> <?php echo $report_comment['reportcommentID']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $report_comment['message']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $report_comment['reason']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $row2['fname']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $report_comment['amount_report']; ?></p>
                      </td>
                      <!-- <td class="v-align-middle">
                        <p><?php echo $report_comment['status']; ?></p>
                      </td> -->
                      <td class="v-align-middle">
                        ...
                        <!-- <button class="btn btn-danger btn-cons m-b-10 btn-rounded block-report-spoiler" 
                                href="block-report-comment.php?action=delete&id=<?php echo $report_comment['reportcommentID']; ?> " 
                                type="button"><i class="fa fa-ban"></i>
                          <span class="bold">ระงับ</span>
                        </button><br> -->
                        <button class="btn btn-danger btn-cons m-b-10 btn-rounded block-report-spoiler" 
                                href="Test-block-comSpo.php?action=edit&id=<?php echo $report_comment['reportcommentID']; ?>" 
                                type="button"><i class="fa fa-ban"></i>
                          <span class="bold">Blok</span>
                        </button>
