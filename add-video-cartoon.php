            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a href="#" class="active" style="font-family: 'Noto Sans Thai', sans-serif;">เพิ่มข้อมูลภาพยนตร์การ์ตูน</a></li>
                </ul>
                <!-- END BREADCRUMB -->
              </div>
            </div>
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group form-group-default ">
                            ...
                            <input style="font-family: 'Noto Sans Thai', sans-serif;" type="text" class="form-control" name="video_name">
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group form-group-default">
                            <label style="font-family: 'Noto Sans Thai', sans-serif;">หมวดหมู่ภาพยนตร์</label>
                            <input style="font-family: 'Noto Sans Thai', sans-serif;" type="text" class="form-control" name="video_genra">
                          </div>
                        </div>
                        <div class="row">
                        <div class="col-sm-6">
                        ...
                        <input style="font-family: 'Noto Sans Thai', sans-serif;" type="text" class="form-control" name="video_subtitles">
                        </div>
                        ...
                        <!-- <button class="btn btn-success pull-right btn-rounded" type="submit" id="buttonAddVideoCartoon" name="buttonAddVideoCartoon">บันทึกข้อมูล</button> -->
                    </form>
                  </div>
