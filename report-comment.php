<?php
  ...
  $sql = "
    ...
    LEFT JOIN comment_spoiler AS c ON rc.comment_id = c.commentID 
    WHERE rc.status = ' '
            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a style="font-family: 'Noto Sans Thai', sans-serif;" href="#" class="active">ข้อมูลรายงานความคิดห็นรีวิวภาพยนตร์สปอยล์รอตรวจสอบ</a>
                  </li>
                </ul>
                <!-- END BREADCRUMB -->
              </div>
          ...
          <div class="container-fluid container-fixed-lg bg-white">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                <div style="font-family: 'Noto Sans Thai', sans-serif; font-size: 15px;" class="panel-title">ข้อมูลรายงานความคิดห็นรีวิวภาพยนตร์สปอยล์รอตรวจสอบ</div>
                ...
                <table class="table table-hover demo-table-search table-responsive-block" id="videoHorrorTable">
                  ...
                  foreach($report_comments AS $index => $report_comment){
                    ...
                    <tr>
                      ...
                      <td class="v-align-middle">
                        <p><?php echo $report_comment['fname']; ?></p>
                      </td>
                      <td class="v-align-middle">
                      ...
                      <td class="v-align-middle">
                        ...
                        <a href="inform-report-com.php?action=send&reportcommentID=<?php echo $row2['member_id']; ?>">
                          <button class="btn btn-danger btn-cons btn-animated btn-rounded">
                          <i class="fa fa-warning"></i><span class="bold">แจ้งเตือน</span>
                          </button>
                        </a><br><br>
                        <a href="update-status-comment.php?action=edit&reportcommentID=<?php echo $report_comment['reportcommentID']; ?>">
