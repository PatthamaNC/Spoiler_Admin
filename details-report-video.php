<?php
      ...
      if(isset ($_GET['action']) && $_GET['action'] == 'edit'){
          $video_id = $_GET['videosID'];
    
        $sql = "
        SELECT * FROM videos WHERE videosID = '" . $video_id . "'
      ";
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                  ...
                  <div class="panel-body">
                    <h5 class="bold" style="font-family: 'Noto Sans Thai', sans-serif; font-size: 21px;">
                      รายละเอียดภาพยนตร์
                    </h5><br>
                    <form class="" role="form" >

                      <label class="bold">ชื่อภาพยนตร์ : <?php echo $videos['name']; ?></label><br><br> <label class=" bold">หมวดหมู่ : <?php echo $videos['category']; ?></label><br><br>
                      <label class="bold">นักแสดง : <?php echo $videos['actor']; ?></label><br><br> <label class=" bold">ผู้กำกับ : <?php echo $videos['director']; ?></label><br><br>
                      <label class="bold">คำบรรยาย : <?php echo $videos['details']; ?></label><br><br>
                      <label class="bold" style="font-family: 'Noto Sans Thai', sans-serif;">รูปภาพหน้าปก</label>
                      <p><img width="250px" height="150px" src="<?php echo $videos['img']; ?>"></p><br>
                      <label class="bold" style="font-family: 'Noto Sans Thai', sans-serif;">วิดีโอ</label>
                      <p>  <video width="250px" height="150px" controls="controls">
