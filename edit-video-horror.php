<?php
      ...
      if(isset($_GET['action']) && $_GET['action'] == 'delete'){
        $videohorrorID = $_GET['videohorrorID'];

      $sql = "
      DELETE FROM videohorror WHERE videohorrorID = '" . $videohorrorID . "'
      ";
...
if(isset ($_GET['action']) && $_GET['action'] == 'edit'){
  ...
  $sql = "
  SELECT * FROM videohorror WHERE videohorrorID = '" . $videohorrorID . "'
";
...
if(move_uploaded_file($_FILES["picture"]["tmp_name"], "../csc2023/uploads/videospoiler/videoimg/" . $fileName)){
  ...
  $sql = "
  UPDATE  videohorror SET
  horror_name = '" . $_POST['horror_name'] . "',
  horror_category= '" . $_POST['horror_category'] . "',
  horror_details= '" . $_POST['horror_details'] . "',
        actor= '" . $_POST['actor'] . "',
        director= '" . $_POST['director'] . "',
        video_horror= '" . $videoUrl . "',
        horror_img= '" . $pictureUrl . "'

      WHERE videohorrorID = '" . $_POST['videohorrorID'] . "'
        ";
      ...
      <div class="panel-heading">
          ...
          <div class="panel-body">
            ...
            <form class="" role="form" name="editVideoForm" id="editVideoForm" action="" method="POST" enctype="multipart/form-data">
              <!--  -->
            <input type="hidden" id="videohorrorID" name="videohorrorID" value="<?php echo $videohorror['videohorrorID']; ?>" > 
            <div class="row">
                <div class="col-sm-6">
                  <div class="form-group form-group-default ">
                    <label style="font-family: 'Noto Sans Thai', sans-serif;">ชื่อภาพยนตร์</label>
                    <input style="font-family: 'Noto Sans Thai', sans-serif;" type="text" class="form-control" name="horror_name" value="<?php echo $videohorror['horror_name']; ?>">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group form-group-default">
                    <label style="font-family: 'Noto Sans Thai', sans-serif;">หมวดหมู่ภาพยนตร์</label>
                    <input style="font-family: 'Noto Sans Thai', sans-serif;" type="text" class="form-control" name="horror_category" value="<?php echo $videohorror['horror_category']; ?>">
                  </div>
                </div>
                <div class="row">
                <div class="col-sm-6">
                  <div class="form-group form-group-default ">
                    ...
                    <input style="font-family: 'Noto Sans Thai', sans-serif;" type="text" class="form-control" name="actor" value="<?php echo $videohorror['actor']; ?>">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group form-group-default">
                    <label style="font-family: 'Noto Sans Thai', sans-serif;">ผู้กำกับ</label>
                    <input style="font-family: 'Noto Sans Thai', sans-serif;" type="text" class="form-control" name="director" value="<?php echo $videohorror['director']; ?>">
                  </div>
                </div>
                </div>
                </div>
                ...
                <input style="font-family: 'Noto Sans Thai', sans-serif;" type="text" class="form-control" name="horror_details" value="<?php echo $videohorror['horror_details']; ?>">
                </div>
              <!-- START PANEL -->
              <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group form-group-default">
                          ...
                          <input type="file" name="video" id="video" class="from-control" value="<?php echo $videohorror['video_horror']; ?>">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group form-group-default">
                          ...
                          <input type="file" name="picture" id="picture" class="from-control" value="<?php echo $videohorror['horror_img']; ?>">
                        </div>
                    </div>
                </div><br>
                <!-- END PANEL -->  
