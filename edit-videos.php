<?php
    ...
    if(isset ($_GET['action']) && $_GET['action'] == 'edit'){
      ...
      $sql = "
      SELECT * FROM videos WHERE videosID = '" . $videosID . "'
    ";
  ...
  $sql.="WHERE videosID = '" . $_POST['videosID'] . "'";
  ...
  <body class="fixed-header ">
            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a href=javascript:history.back(1) style="font-family: 'Noto Sans Thai', sans-serif;">ข้อมูลวิดีโอภาพยนตร์สปอยล์</a></li>
                  <li><a href="#" class="active" style="font-family: 'Noto Sans Thai', sans-serif;">แก้ไขข้อมูลวิดีโอภาพยนตร์สปอยล์</a></li>
                </ul>
                <!-- END BREADCRUMB -->
              </div>
            </div>
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                  ...
                  <div class="panel-body">
                        <h5 class="center bo" style="font-family: 'Noto Sans Thai', sans-serif; margin-left: 42%; font-weight: bold;">
                        แก้ไขข้อมูลวิดีโอภาพยนตร์สปอยล์
						            </h5><br>
                    <form class="" role="form" name="editVideoActionForm" id="editVideoActionForm" action="" method="POST" enctype="multipart/form-data">
                      <!--  -->
                    <input type="hidden" id="videosID" name="videosID" value="<?php echo $videos['videosID']; ?>" > 
                    <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group form-group-default ">
                            <label style="font-family: 'Noto Sans Thai', sans-serif;">ชื่อภาพยนตร์</label>
                            <input type="text" class="form-control" name="name" style="font-family: 'Noto Sans Thai', sans-serif;" value="<?php echo $videos['name']; ?>">
                          </div>
                        </div>
                        <div class="col-sm-6">
                        <div class="form-group form-group-default form-group-default-select2  Form">
                        
                          <select id="category" name="category" class="full-width" data-init-plugin="select2" >
                          <?php
                            $IsSeIect1 = '';
                            $IsSeIect2 = '';
                            $IsSeIect3 = '';
                            ...
                            if ($videos['category'] == 1){
                              $IsSeIect2 = 'selected';
                            }
                            if ($videos['category'] == 3){
                              $IsSeIect3 = 'selected';
                            }
                            if ($videos['category'] == 4){
                              $IsSeIect4 = 'selected';
                            }

                            ?>
                            <option value="แอ็กชัน" <?php echo $IsSeIect1 ?>> แอ็กชัน </option>
                            <option value="โรแมนติก" <?php echo $IsSeIect2 ?>> โรแมนติก </option>
                            <option value="การ์ตูน" <?php echo $IsSeIect3 ?>> การ์ตูน </option>
                            <option value="สยองขวัญ" <?php echo $IsSeIect4 ?>> สยองขวัญ </option>
                          </select>
                          </div>
                        </div>
                        <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group form-group-default ">
                            ...
                            <input type="text" class="form-control" name="actor" style="font-family: 'Noto Sans Thai', sans-serif;" value="<?php echo $videos['actor']; ?>">
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group form-group-default">
                            <label style="font-family: 'Noto Sans Thai', sans-serif;">ผู้กำกับ</label>
                            <input type="text" class="form-control" name="director" style="font-family: 'Noto Sans Thai', sans-serif;" value="<?php echo $videos['director']; ?>">
                          </div>
                        </div>
                        </div>
                        </div>
                        ...
                        <input type="text" class="form-control" name="details" style="font-family: 'Noto Sans Thai', sans-serif;" value="<?php echo $videos['details']; ?>">
                        </div>
                      <!-- START PANEL -->
                      <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group form-group-default">
                                  ...
                                  <input type="file" name="video" id="video" class="from-control" value="<?php echo $videos['videos']; ?>">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group form-group-default">
                                  ...
                                  <input type="file" name="picture" id="picture" class="from-control" value="<?php echo $videos['img']; ?>">
                                </div>
                            </div>
                        </div><br>
                        <!-- END PANEL -->  
                        <button type="submit" id="buttonEditVideoAction" name="buttonEditVideoAction" class="btn btn-primary btn-cons btn-animated from-top fa fa-arrow-down  but_save">
    ...
    $(function()
    {
      ...
      $("#video").fileinput({
            ...
            initialPreview: "<?php echo $videos['videos']; ?>",
      ...
      $("#picture").fileinput({
        ...
        maxFileCount: 10,
        mainClass:"input-group-md",
        initialPreview: ['<img src="<?php echo $videos['img']; ?>" class="kv-preview-data file-preview-image">']
      });
    })
    </script>
  </body>
