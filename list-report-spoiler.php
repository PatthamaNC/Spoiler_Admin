<?php
    ...
    include("block-report-spoiler02.php");
            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a style="font-family: 'Noto Sans Thai', sans-serif;" href="#" class="active">ข้อมูลรายงานรีวิวภาพยนตร์สปอยล์</a>
                  </li>
                </ul>
                <!-- END BREADCRUMB -->
              </div>
          ...
          <div class="container-fluid container-fixed-lg bg-white">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                <div style="font-family: 'Noto Sans Thai', sans-serif; font-size: 15px;" class="panel-title">ข้อมูลรายงานรีวิวภาพยนตร์สปอยล์</div>
                ...
                <table class="table table-hover demo-table-search table-responsive-block" id="videoHorrorTable">
                  ...
                  foreach($report_spoilers AS $index => $report_spoiler){
                    ...
                    <tr>
                      ...
                      <td class="v-align-middle">
                        <p><?php echo $report_spoiler['amount_report']; ?></p>
                      </td>
                      <td class="v-align-middle">
                      ...
                      <a href="details-report-spoiler.php?action=edit&spoilerID=<?php echo $report_spoiler['spoiler_id']; ?>">
                        ...
                        <!-- <button class="btn btn-danger btn-cons m-b-10 btn-rounded block-report-spoiler" 
                                href="block-report-spoiler02.php?action=delete&id=<?php echo $report_spoiler['spoiler_id']; ?> " 
