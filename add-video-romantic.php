       ...
       $sql = "
          INSERT INTO videoromantic(
                ...
                romantic_img
                        ...
                        '" . $_POST['romantic_name'] . "',
                        '" . $_POST['romantic_category'] . "',
                        '" . $_POST['romantic_details'] . "',
                        '" . $_POST['actor'] . "',
                        '" . $_POST['director'] . "',
                        '" . $videoUrl . "',
                        '" . $pictureUrl . "'
            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a style="font-family: 'Noto Sans Thai', sans-serif;" href="#" class="active">เพิ่มข้อมูลภาพยนตร์โรแมนติก</a></li>
                </ul>
                <!-- END BREADCRUMB -->
              </div>
            </div>
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group form-group-default ">
                            ...
                            <input style="font-family: 'Noto Sans Thai', sans-serif;" type="text" class="form-control" name="romantic_name">
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group form-group-default">
                            <label style="font-family: 'Noto Sans Thai', sans-serif;">หมวดหมู่ภาพยนตร์</label>
                            <input style="font-family: 'Noto Sans Thai', sans-serif;" type="text" class="form-control" name="romantic_category">
                          </div>
                        </div>
                        <div class="row">
                        <div class="col-sm-6">
                        ...
                        <div class="form-group form-group-default  ">
                          ...
                          <input style="font-family: 'Noto Sans Thai', sans-serif;" type="text" class="form-control" name="romantic_details">
                        </div>
