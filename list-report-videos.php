<?php
    ...
    include("block-report-video.php");
...
";
    ...
    $report_videos = $result->fetch_all(MYSQLI_ASSOC);
    // echo '<pre>';
            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a style="font-family: 'Noto Sans Thai', sans-serif;" href="#" class="active">ข้อมูลรายงานวิดีโอภาพยนตร์สปอยล์</a>
                  </li>
                </ul>
                <!-- END BREADCRUMB -->
              </div>
          ...
          <div class="container-fluid container-fixed-lg bg-white">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                <div style="font-family: 'Noto Sans Thai', sans-serif; font-size: 15px;" class="panel-title">ข้อมูลรายงานวิดีโอภาพยนตร์สปอยล์</div>
                ...
                <table class="table table-hover demo-table-search table-responsive-block" id="videoHorrorTable">
                  <thead>
                    <tr>
                      ...
                      <!-- <th style="font-family: 'Noto Sans Thai', sans-serif;">เนื้อหาภาพยนตร์</th> -->
                  ...
                  <tbody>
                  <?php
                  foreach($report_videos AS $index => $report_video){
                    ?>
                  
                    <tr>
                      <td class="v-align-middle semi-bold">
                        <p> <?php echo $report_video['reportvideoID']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $report_video['name']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $report_video['fname']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $report_video['reason']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $report_video['amount_report']; ?></p>
                      </td>
                      <!-- <td class="v-align-middle">
                      ...
                      <td class="v-align-middle">
                        ...
                        <a href="details-report-video.php?action=edit&videosID=<?php echo $report_video['video_id']; ?>">
                        ...
                        <!-- <button class="btn btn-danger btn-cons m-b-10 btn-rounded block-report-video" 
                                href="block-report-video.php?action=delete&id=<?php echo $report_video['video_id']; ?> " 
...
var initvideoHorrorTable = function() {
    ...
    $("#videoHorrorTable").delegate(".block-report-video", "click", function (event) {
        event.preventDefault();
        Swal.fire({
            title: 'คุณต้องการระงับ VDO ใช่ หรือ ไม่?',
            text: "",
            icon: 'warning',
