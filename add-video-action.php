            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a href=javascript:history.back(1) style="font-family: 'Noto Sans Thai', sans-serif;">ข้อมูลภาพยนตร์แอ็กชัน</a></li>
                  <li><a href="#" class="active" style="font-family: 'Noto Sans Thai', sans-serif;">เพิ่มข้อมูลภาพยนตร์แอ็กชั่น</a></li>
                </ul>
                <!-- END BREADCRUMB -->
              </div>
            </div>
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group form-group-default ">
                            ...
                            <input type="text" class="form-control" name="action_name" style="font-family: 'Noto Sans Thai', sans-serif;">
                          </div>
                        </div>
                        ...
                        <input type="text" class="form-control" name="action_details" style="font-family: 'Noto Sans Thai', sans-serif;">
                        </div>
                        ...
                        <button type="submit" id="buttonAddVideoCartoon" name="buttonAddVideoCartoon" class="btn btn-primary btn-cons btn-animated from-top fa fa-arrow-down btn-rounded btn-save">
