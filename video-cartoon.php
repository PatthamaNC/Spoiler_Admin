            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a style="font-family: 'Noto Sans Thai', sans-serif;" href="#" class="active">ข้อมูลภาพยนตร์การ์ตูน</a>
                  </li>
                </ul>
                <!-- END BREADCRUMB -->
              </div>
          ...
          <div class="container-fluid container-fixed-lg bg-white">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                <div style="font-family: 'Noto Sans Thai', sans-serif;" class="panel-title">ข้อมูลภาพยนตร์การ์ตูน</div>
                <div class="pull-right">
                  ...
                  <div class= "col-xs-4" >
                     <button type="submit" class="btn btn-complete btn-cons btn-animated from-left fa fa-plus btn-rounded" id="aadVideoaction">
                  ...
                  foreach($videos AS $index => $video){
                    ...
                    <tr>
                      <td class="v-align-middle semi-bold">
                        <p> <?php echo $video['videoID']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $video['video_name']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $video['video_genra']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $video['video_subtitles']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $video['actor']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $video['director']; ?></p>
                      </td>
                      <td class="v-align-middle">
                      <video width="300" height="150" controls="controls">
                        <source src="<?php echo $video['videocartoon']; ?>" type="video/mp4">
                      </video>
                      </td>
                      <td class="v-align-middle">
                        <p><img width="300px" height="150px" src="<?php echo $video['videoimg']; ?>"></p>
                      </td>


                      <td class="v-align-middle">
                      <div>
                        <a href="edit-video-cartoon.php?action=edit&videoID=<?php echo $video['videoID']; ?> ">
                        ...
                        <br>
                        <div>
                        <a class="edit-video-action" href="edit-video-cartoon.php?action=delete&videoID=<?php echo $video['videoID']; ?> ">
                          <button class="btn btn-danger btn-cons btn-animated from-left pg pg-trash btn-rounded">
                            <span>ลบ</span>
                          </button>
                        </a>
                      </div>
                        <!-- <a class="btn btn-tag" href="edit-video-cartoon.php?action=edit&videoID=<?php echo $video['videoID']; ?> ">แก้ไข</a> -->
                        <!-- <a class="btn btn-tag edit-video-action"  href="edit-video-cartoon.php?action=dalete&videoID=<?php echo $video['videoID']; ?> ">ลบ</a> -->
...
var initspoilerTable = function() {
    ...
    $('#aadVideoaction').click(function () {
      ...
      window.location.href = "add-video-cartoon.php";
    });
