<?php
  ...
  include("database.php");
    if(isset ($_GET['action']) && $_GET['action'] == 'edit'){
        ...
        $sql = "
        SELECT * FROM report_commentvdo WHERE repoctComVdoID = '" . $repoctComVdoID . "'
      ";
      ...
      $report_commentvdo = $result->fetch_assoc();
      // echo '<pre>';
      // print_r($report_comment);
      // exit;
      }
      
      if(isset($_POST['buttonEditVideo'])){
        $sql = "
        UPDATE  report_commentvdo SET
            status = '" . $_POST['status'] . "'

            WHERE repoctComVdoID = '" . $_POST['repoctComVdoID'] . "'
              ";
              ...
              header("location:report-commentVDO.php");
              exit();
      }
?>
<!DOCTYPE html>
            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a style="font-family: 'Noto Sans Thai', sans-serif;" href="#" class="active">แก้ไขสถานะความคิดเห็น</a></li>
                </ul>
                <!-- END BREADCRUMB -->
              </div>
            </div>
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                  ...
                  <div class="panel-body" >
                        ...
                        แก้ไขสถานะความคิดเห็น
						            </h5><br>
                    <form class="" role="form" name="editVideoForm" id="editVideoForm" action="" method="POST" enctype="multipart/form-data">
                      <!--  -->
                    <input type="hidden" id="repoctComVdoID" name="repoctComVdoID" value="<?php echo $report_commentvdo['repoctComVdoID']; ?>" > 
                    <div class="row">
                        <div class="col-sm-8">
                      ...
                      <div class="form-group form-group-default form-group-default-select2 required Form">
                        ...
                        <select id="status" name="status" class="full-width" data-init-plugin="select2" >
                          <?php
                            $IsSeIect1 = '';
                            $IsSeIect2 = '';
                            if ($report_commentvdo['status'] == 0){
                              $IsSeIect1 = 'selected';
                            }
                            if ($report_commentvdo['status'] == 1){
                              $IsSeIect2 = 'selected';
                            }
                            ?>
