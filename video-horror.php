<?php
    ...
    $sql = "
    SELECT * FROM videohorror
    ORDER BY videohorrorID DESC
    ";
    ...
    $videohorrors = $result->fetch_all(MYSQLI_ASSOC);
    // echo '<pre>';
    // print_r($spoilers);
    // exit;
?>
            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a href="#" class="active"  style="font-family: 'Noto Sans Thai', sans-serif;">ข้อมูลภาพยนตร์สยองขวัญ</a>
                  </li>
                </ul>
                <!-- END BREADCRUMB -->
              </div>
          ...
          <div class="container-fluid container-fixed-lg bg-white">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                <div style="font-family: 'Noto Sans Thai', sans-serif;" class="panel-title">ข้อมูลภาพยนตร์สยองขวัญ</div>
                <div class="pull-right">
                  ...
                  <div class= "col-xs-4" >
                     <button class="btn btn-complete btn-cons btn-animated from-left fa fa-plus btn-rounded" id="aadVideoHorror">
              ...
              <div  class="panel-body">
                <table class="table table-hover demo-table-search table-responsive-block" id="videoHorrorTable">
                  ...
                  <tbody>
                  <?php
                  foreach($videohorrors AS $index => $videohorror){
                    ?>
                  
                    <tr>
                      <td class="v-align-middle semi-bold">
                        <p> <?php echo $videohorror['videohorrorID']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $videohorror['horror_name']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $videohorror['horror_category']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $videohorror['horror_details']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $videohorror['actor']; ?></p>
                      </td>
                      <td class="v-align-middle">
                        <p><?php echo $videohorror['director']; ?></p>
                      </td>
                      <td class="v-align-middle">
                      <video width="250px" height="125px" controls="controls">
                        <source src="<?php echo $videohorror['video_horror']; ?>" type="video/mp4">
                      </video>
                      </td>
                      <td class="v-align-middle">
                        <p><img width="250px" height="125px" src="<?php echo $videohorror['horror_img']; ?>"></p>
                      </td>

                      <td class="v-align-middle">
                      <div>
                        <a href="edit-video-horror.php?action=edit&videohorrorID=<?php echo $videohorror['videohorrorID']; ?> ">
                        ...
                        <br>
                        <div>
                        <a class="edit-video-horror" href="edit-video-horror.php?action=delete&videohorrorID=<?php echo $videohorror['videohorrorID']; ?> " >
                        ...
                        <!-- <a class="btn btn-tag"  href="edit-video-horror.php?action=edit&videohorrorID=<?php echo $videohorror['videohorrorID']; ?> ">แก้ไข</a> -->
                        <!-- <a class="btn btn-tag edit-video-horror"  href="edit-video-horror.php?action=dalete&videohorrorID=<?php echo $videohorror['videohorrorID']; ?> ">ลบ</a> -->
...
var initvideoHorrorTable = function() {
    ...
    $("#videoHorrorTable").delegate(".edit-video-horror", "click", function (event) {
