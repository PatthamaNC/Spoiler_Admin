<?php
  ...
  include("database.php");
    if(isset ($_GET['action']) && $_GET['action'] == 'edit'){
        $reportcommentID = $_GET['reportcommentID'];

        $sql = "
        SELECT * FROM report_comment WHERE reportcommentID = '" . $reportcommentID . "'
      ";
      ...
      $report_comment = $result->fetch_assoc();
      // echo '<pre>';
      ...
      if(isset($_POST['buttonEditVideo'])){
        ...
        UPDATE  report_comment SET
            ...
            WHERE reportcommentID = '" . $_POST['reportcommentID'] . "'
              ";
              ...
              header("location:report-comment.php");
              exit();
      }
?>
<!DOCTYPE html>
              ...
              <div class="panel-heading">
                  ...
                  <div class="panel-body" >
                    ...
                    <form class="" role="form" name="editVideoForm" id="editVideoForm" action="" method="POST" enctype="multipart/form-data">
                      <!--  -->
                    <input type="hidden" id="videoromanticID" name="reportcommentID" value="<?php echo $report_comment['reportcommentID']; ?>" > 
                    <div class="row">
                        <div class="col-sm-8">
                      ...
                      <div class="form-group form-group-default form-group-default-select2 required Form">
                        ...
                        <select id="status" name="status" class="full-width" data-init-plugin="select2" >
                          <?php
                            $IsSeIect1 = '';
                            $IsSeIect2 = '';
                            if ($report_comment['status'] == 0){
                              $IsSeIect1 = 'selected';
                            }
                            if ($report_comment['status'] == 1){
                              $IsSeIect2 = 'selected';
                            }
                            ?>
